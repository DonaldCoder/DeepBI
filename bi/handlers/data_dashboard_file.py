...
class DataDashboardFileResource(BaseResource):  # BaseResource
    ...
    def get(self, data_report_file_id=None):
        ...
        if data_report_file_id:
            try:
                data = models.DataDashboardFile.file_info(data_report_file_id, user_id)
            ...
            result = models.DataDashboardFile.get_user_files(user_id)
    ...
    def post(self):
        ...
        history_result = models.DataDashboardFile.get_user_files(user_id)
        ...
        pass
        result = models.DataDashboardFile(
            user_id=user_id,
    ...
    def delete(self, data_report_file_id):
        user_id = self.current_user.id
        try:
            data = models.DataDashboardFile.file_info(
                data_report_file_id,
                user_id
            )
            file_name = os.path.join(settings.DATA_SOURCE_FILE_DIR, data.filename)
